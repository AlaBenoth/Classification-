...
public class LinearPerceptronTests : ClassifierTests
{
	[Ignore("Slow")]
	[Test]
	public void TestTrain()
	{
		...
		Assert.AreEqual(8.67, 100 * linearPerceptron.Test(iris.GetInstanceList()).GetErrorRate(),
			0.01);
		...
		Assert.AreEqual(31.88, 100 * linearPerceptron.Test(bupa.GetInstanceList()).GetErrorRate(),
			0.01);
