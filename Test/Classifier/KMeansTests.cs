...
public class KMeansTests : ClassifierTests
{
	[Test]
	...
	public void TestTrain()
	{
		...
		Assert.AreEqual(45.08, 100 * kMeans.Test(dermatology.GetInstanceList()).GetErrorRate(),
			0.01);
		...
		Assert.AreEqual(38.94, 100 * kMeans.Test(tictactoe.GetInstanceList()).GetErrorRate(),
			0.01);
