...
namespace Classification.Tests.DataSet;

public class DataSetTests
{
	private Classification.DataSet.DataSet iris, car, chess, bupa, tictactoe, dermatology,
		nursery;
	...
	public void TestGetClasses()
	{
		...
		Assert.AreEqual("recommend;priority;not_recom;very_recom;spec_prior",
			nursery.GetClasses());
		Assert.AreEqual(
