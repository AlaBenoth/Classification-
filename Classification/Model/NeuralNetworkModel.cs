...
public abstract class NeuralNetworkModel : ValidatedModel
{
	...
	protected Matrix AllocateLayerWeights(int row, int column, Random random) =>
		new Matrix(row, column, -0.01, +0.01, random);
	...
	/**
	 * <summary>
	 *   The createInputVector method takes an {@link Instance} as an input. It converts given Instance to the {@link
	 *   java.util.Vector}
	...
	/**
	 * <summary>
	 *   The predictWithCompositeInstance method takes an List possibleClassLabels. It returns the class label
	...
	/**
	 * <summary>
	 *   The predict method takes an {@link Instance} as an input, converts it to a Vector and calculates the {@link Matrix} y
	 *   by
