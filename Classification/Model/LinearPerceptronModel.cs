...
public class LinearPerceptronModel : NeuralNetworkModel
{
	 ...
	 */
	public LinearPerceptronModel(InstanceList.InstanceList trainSet,
		InstanceList.InstanceList validationSet, LinearPerceptronParameter parameters) :
		base(trainSet)
	{
	...
	/**
         ...
         */
	protected override void CalculateOutput() => y = W.MultiplyWithVectorFromRight(x);
}