...
{
	private readonly List<DecisionTree.DecisionTree> forest;
	 ...
	 */
	public TreeEnsembleModel(List<DecisionTree.DecisionTree> forest) => this.forest = forest;

	/**
	 * <summary>
	 *   The predict method takes an {@link Instance} as an input and loops through the {@link ArrayList} of {@link
	 *   DecisionTree}s.
