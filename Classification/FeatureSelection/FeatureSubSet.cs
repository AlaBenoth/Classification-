...
public class FeatureSubSet : ICloneable
{
	 ...
	 */
	public FeatureSubSet(List<int> indexList) => this.indexList = indexList;
	...
	/**
         ...
         */
	public FeatureSubSet() => indexList = new List<int>();
	 ...
	 */
	public int Size() => indexList.Count;
	 ...
	 */
	public int Get(int index) => indexList[index];
	 ...
	 */
	public bool Contains(int featureNo) => indexList.Contains(featureNo);
	 ...
	 */
	public void Add(int featureNo) => indexList.Add(featureNo);
	 ...
	 */
	public void Remove(int index) => indexList.RemoveAt(index);
}