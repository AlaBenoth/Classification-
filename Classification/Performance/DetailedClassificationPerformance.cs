...
public class DetailedClassificationPerformance : ClassificationPerformance
{
	...
	/**
	 * <summary>
	 *   A constructor that  sets the accuracy and errorRate as 1 - accuracy via given {@link ConfusionMatrix} and
	 *   also sets the confusionMatrix.
	 * </summary>
	...
	public DetailedClassificationPerformance(ConfusionMatrix confusionMatrix) :
		base(confusionMatrix.GetAccuracy()) =>
	 ...
	 */
	public ConfusionMatrix GetConfusionMatrix() => confusionMatrix;
}