...
public class DataSet
{
	...
	/**
	 * <summary>
	 *   Constructor for generating a new {@link DataSet} with a {@link DataDefinition}, from a {@link File} by using
	 *   a separator.
	 * </summary>
	 * <param name="definition">Data definition of the data set.</param>
	...
	/**
	 * <summary>
	 *   Adds the attribute types according to given {@link Instance}. For instance, if the attribute type of given {@link
	 *   Instance}
	 ...
	 */
	public int SampleSize() => _instances.Size();
	 ...
	 */
	public int ClassCount() => _instances.ClassDistribution().Count;
	 ...
	 */
	public int AttributeCount() => _definition.AttributeCount();
	 ...
	 */
	public int DiscreteAttributeCount() => _definition.DiscreteAttributeCount();
	 ...
	 */
	public int ContinuousAttributeCount() => _definition.ContinuousAttributeCount();
	...
	public string ToString(string dataSetName) =>
		string.Format("{0}{1:F15}{2:F15}{3:F20}{4:F15}{5:F15}", dataSetName, SampleSize(),
			ClassCount(), AttributeCount(), DiscreteAttributeCount(), ContinuousAttributeCount());
	 ...
	 */
	public List<Instance.Instance> GetInstances() => _instances.GetInstances();
	...
	public List<Instance.Instance>[] GetClassInstances() =>
		_instances.DivideIntoClasses().GetLists();

	/**
	 * <summary> Accessor for the {@link InstanceList}.</summary>
	 * <returns>The {@link InstanceList}.</returns>
	 */
	public InstanceList.InstanceList GetInstanceList() => _instances;

	public InstanceList.InstanceList SplitDataSet(int percentage)
	{
		_instances.Shuffle(1);
		var instanceList = GetInstances();
		var index = instanceList.Count * percentage / 100;
		var data = instanceList.ToArray()[..index];
		return new InstanceList.InstanceList(data.ToList());
	}
	 ...
	 */
	public DataDefinition GetDataDefinition() => _definition;
