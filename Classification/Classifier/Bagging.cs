...
public class Bagging : Classifier
{
	 ...
	 *   This training method is for a bagged decision tree classifier. 20 percent of the instances are left aside for pruning
	 *   of the trees
	 *   80 percent of the instances are used for training the trees. The number of trees (forestSize) is a parameter, and
	 *   basically
	 *   the method will learn an ensemble of trees as a model.
	 * </summary>
	 * <param name="trainSet">  Training data given to the algorithm.</param>
	 * <param name="parameters">
	 *   Parameters of the bagging trees algorithm. ensembleSize returns the number of trees in the
	 *   bagged forest.
	 * </param>
	 */
		...
		Parameter.Parameter parameters)
	{
		...
		for (var i = 0; i < forestSize; i++)
		{
			...
			var tree =
				new DecisionTree(new DecisionNode(
					new InstanceList.InstanceList(bootstrap.GetSample()), null, null, false));
			forest.Add(tree);
		}
