...
public class AutoEncoder : Classifier
{
	/**
	 * <summary>
	 *   Training algorithm for auto encoders. An auto encoder is a neural network which attempts to replicate its
	 *   input at its output.
	 * </summary>
	...
	public override Performance.Performance Test(InstanceList.InstanceList testSet) =>
		((AutoEncoderModel) model).TestAutoEncoder(testSet);
}