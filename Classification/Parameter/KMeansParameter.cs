...
public class KMeansParameter : Parameter
{
	 ...
	 */
	public KMeansParameter(int seed) : base(seed) => distanceMetric = new EuclidianDistance();
	 ...
	 */
	public KMeansParameter(int seed, DistanceMetric.DistanceMetric distanceMetric) :
		base(seed) =>
	 ...
	 */
	public DistanceMetric.DistanceMetric GetDistanceMetric() => distanceMetric;
}