...
public class DeepNetworkParameter : LinearPerceptronParameter
{
	...
	public DeepNetworkParameter(int seed, double learningRate, double etaDecrease,
		double crossValidationRatio, int epoch, List<int> hiddenLayers,
	 ...
	 */
	public int LayerSize() => hiddenLayers.Count;
	 ...
	 */
	public int GetHiddenNodes(int layerIndex) => hiddenLayers[layerIndex];
