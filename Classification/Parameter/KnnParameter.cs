...
public class KnnParameter : KMeansParameter
{
	 ...
	 */
	public KnnParameter(int seed, int k, DistanceMetric.DistanceMetric distanceMetric) :
		base(seed, distanceMetric) =>
		this.k = k;
	 ...
	 * <param name="k">             Parameter of the K-nearest neighbor algorithm.</param>
	 */
	public KnnParameter(int seed, int k) : base(seed) => this.k = k;
