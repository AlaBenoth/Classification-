...
public class Combined5X2F : PairedTests
{
	private double TestStatistic(ExperimentPerformance classifier1,
		...
		ExperimentPerformance classifier2)
	{
		...
		return new StatisticalTestResult(
			Distribution.FDistribution(statistic, degreeOfFreedom1, degreeOfFreedom2), true);
	}
}