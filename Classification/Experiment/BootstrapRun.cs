...
{
	private readonly int numberOfBootstraps;
	 ...
	 */
	public BootstrapRun(int numberOfBootstraps) => this.numberOfBootstraps = numberOfBootstraps;
	...
	public ExperimentPerformance Execute(Experiment experiment)
	{
		...
		for (var i = 0; i < numberOfBootstraps; i++)
		{
