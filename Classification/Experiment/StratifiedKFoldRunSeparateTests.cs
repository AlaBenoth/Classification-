...
public class StratifiedKFoldRunSeparateTests : KFoldRunSeparateTests
{
	/**
	 * <summary>
	 *   Constructor for StratifiedKFoldRunSeparateTests class. Basically sets K parameter of the K-fold
	 *   cross-validation.
	 * </summary>
	 * <param name="k">K of the K-fold cross-validation.</param>
	 */
	public StratifiedKFoldRunSeparateTests(int k) : base(k) { }
