...
public class KFoldRunSeparateTests : KFoldRun
{
	/**
         * Constructor for KFoldRunSeparateTests class. Basically sets K parameter of the K-fold cross-validation.
         *
         * @param K K of the K-fold cross-validation.
         */
	public KFoldRunSeparateTests(int k) : base(k) { }

	// ReSharper disable once TooManyArguments
	protected void RunExperiment(Classifier.Classifier classifier,
		Parameter.Parameter parameter, ExperimentPerformance experimentPerformance,
		CrossValidation<Instance.Instance> crossValidation, InstanceList.InstanceList testSet)
	{
		for (var i = 0; i < K; i++)
		{
