...
public class InstanceClassComparator : IComparer<Instance>
{
	 ...
	 * <returns>
	 *   Negative value if the class label of the first instance is less than the class label of the second instance.
	...
	public int Compare(Instance x, Instance y) =>
		string.Compare(x.GetClassLabel(), y.GetClassLabel(), StringComparison.Ordinal);
}